<?php
/**
 * LottoExpert.net — Nebraska Pick 5 Results Intelligence Page
 * Joomla 5.x + PHP 8.1+
 *
 * PURPOSE
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    $doc->setTitle($stateName . ' ' . $gName . ' Results Analysis — Frequency, Recency & Draw History | LottoExpert.net');
    $doc->setMetaData('description', 'Explore verified draw history, number frequency, recency, active and quiet number analysis for ' . $stateName . ' ' . $gName . '. Analytical tools powered by LottoExpert.');
}
...
$schemaData = [
    ...
    '@type'       => 'WebPage',
    'name'        => (isset($stateName, $gName) ? htmlspecialchars($stateName . ' ' . $gName . ' Results Analysis', ENT_QUOTES, 'UTF-8') : 'Lottery Results Analysis'),
    'description' => 'Frequency, recency, and draw history analysis for ' . (isset($gName) ? htmlspecialchars((string) $gName, ENT_QUOTES, 'UTF-8') : 'Nebraska Pick 5') . '. Explore active numbers, quiet stretches, and full distribution.',
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=NE1">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=NE1">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=NE1">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=NE1">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/nebraska-pick-5-heatmap-analysis">Heatmap Analysis</a>
          </div>
        </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Main numbers from the latest draw that also appeared in recent trailing draws.</div>
      </div>
    </article>
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Draw window currently loaded for this analysis page view.</div>
      </div>
    </article>
  </section>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view. This layer is designed for fast orientation: which numbers are most active, which are quiet, and how the current draw relates to recent history. Numbers 01&ndash;<?php echo (int) $mainMax; ?> are tracked across all five main ball positions.
        </p>
      </div>
    </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The first panel shows the complete main-number distribution across all values 01&ndash;<?php echo (int) $mainMax; ?>. The second panel shows the recency distribution — how many draws ago each number was last seen — across the same window.
        </p>
      </div>
    </div>
    ...
    <div class="skai-section-body">
      ...
      <div class="skai-note">
        The complete distribution is best used as a reference layer. The overview modules above are optimized for quick reading; this section is optimized for thorough review. Recency values represent the number of draws since each number last appeared — a higher value indicates a longer absence.
      </div>
    </div>
  </section>
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Use the table for exact counts, recency, and personal tracking. Quick filters help narrow the view without losing full access to the complete dataset. Adjust the draw window to load more or fewer historical drawings for comparison.
        </p>
      </div>
    </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=NE1">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=NE1">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=NE1">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=NE1">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/nebraska-pick-5-heatmap-analysis">Heatmap Analysis</a>
        <a class="skai-utility-link" href="/lottery-archives-pick5?gId=<?php echo rawurlencode((string) $gId); ?>&amp;stateName=<?php echo rawurlencode((string) $stateName); ?>&amp;gName=<?php echo rawurlencode((string) $gName); ?>&amp;sTn=<?php echo rawurlencode(strtolower((string) $stateAbrev)); ?>">Lottery Archives</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          This page is designed to help users understand recent and historical behavior more clearly, not to imply certainty about future draws.
        </p>
      </div>
    </div>
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. The <?php echo htmlspecialchars((string) $gName, ENT_QUOTES, 'UTF-8'); ?> draws five main numbers from a pool of 01&ndash;<?php echo (int) $mainMax; ?>. Each draw is independent; no number is statistically &ldquo;due.&rdquo; The purpose of this page is to make the recent behavior of the game easier to understand, compare, and carry into deeper SKAI analysis.
      </div>
    </div>
  </section>
